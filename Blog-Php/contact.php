...
<html lang="fr">
    ...
    <head>
        ...
        <title>Graoully-Blog | Contact</title>
    </head>
            ...
            <div class="dev_liste">
                ...
                <div class="dev_membre">
                    ...
                    <div class="dev_social">
                        <img src="images/thomas.png" alt="Thomas" class="dev_photo">
                        <p class="dev_texte">I love php</p>
                    </div>

                    <div class="dev_comptes">
                    <a href="https://twitter.com" target="_blank"><img src="images/twitter.png" alt="" class="dev_compte"></a>
                        <a href="https://linkedin.com" target="_blank"><img src="images/linkedin.png" alt="" class="dev_compte"></a>
                        <a href="https://github.com" target="_blank"><img src="images/github.png" alt="" class="dev_compte"></a>
                    </div>
                ...
                <div class="dev_membre">
                    ...
                    <div class="dev_social">
                        ...
                        <p class="dev_texte">php is life</p>
                    </div>
                ...
                <div class="dev_membre">
                    ...
                    <div class="dev_social">
                        <img src="images/jeremie.jpg" alt="Jérémie" class="dev_photo">
                        <p class="dev_texte">php is my soulmate</p>
                    </div>
